...
a, b = spectrum(4*pi, 64*4, cos3, xlim1=3, windowing=False,
                title1=r"Spectrum of $cos^3(w_0t)$")
a, b = spectrum(4*pi, 64*4, cos3, xlim1=3, windowing=True,
                title1=r"Spectrum of $cos^3(w_0t)$")


w, Y = spectrum(pi, 128, cosine, xlim1=3, windowing=True,
...
w, Y = spectrum(pi, 128, noisycosine, xlim1=3, windowing=True,
                title1=r"Spectrum of $cos(w_0t + \delta)$")
...
w, Y = spectrum(pi, 1024, chirp, xlim1=60, windowing=True,
                title1=r"Spectrum of chirp function")
w, Y = spectrum(pi, 1024, chirp, xlim1=60, windowing=False,
                title1=r"Spectrum of chirp function")
...
for i in range(len(t_arrays)):
    w, Y = spectrum(lim=10, t_=t_arrays[i], t_lims=True, n=64, f=chirp, xlim1=60,
                    windowing=False, title1=r"Spectrum of chirp function", show_=False)
    Y_mags[i] = abs(Y)
    Y_angles[i] = angle(Y)
# plotting
fig = plt.figure()
...
surf = ax.plot_surface(w, t, Y_mags.T, cmap=cm.coolwarm,
